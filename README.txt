...
SOBRE LOS ARCHIVOS DE JUEGOS Y LAS CARPETAS
	...
	Las categorias de cada juego no necesariamente reflejan la realidad 
...
SOBRE LA APLICACIÓN DE LA CONSOLA
	...
	☆ Fase 1: Lista de categorias. Se desplega la lista de categorias disponibles. El
	...
	☆ Fase 2: Lista de juegos. Se desplega la lista de juegos ordenada según el número de categorias.
	El usuario puede acceder a la información de juego al ingresar su número. Se puede volver a la lista
	de las categorias al ingresar 0.
+---------------------------------------------------------+
